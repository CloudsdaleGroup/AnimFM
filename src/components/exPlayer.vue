<template>
    ...
    <div class="bd sm2-main-controls" style="background-color: rgb(63, 130, 255) ">
    ...
    <div class="bd sm2-playlist-drawer sm2-element" style="background-color: rgb(77, 77, 77); height: 0px;">
        ...
        <div class="sm2-playlist-wrapper">
            <ul class="sm2-playlist-bd">
                <li><a href="http://frrelay.cloudsdaleradio.com/AnimeFM.mp3"><b>AnimeFM</b><span class="label">128Kbps
                            MP3</span></a></li>
                ...
                <li><a href="http://frrelay.cloudsdaleradio.com/AnimeFM64.mp3"> <b>AnimeFM</b><span class="label">64Kbps
                            Mobile Quality</span></a></li>
                <li><a href="http://frrelay.cloudsdaleradio.com/AnimeFM320.mp3"><b>AnimeFM</b><span
                            class="label">320Kbps Hight Quality</span></a></li>
            </ul>
        </div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="col-md-offset-2">
            <h4 class="text-left" style="position:relative;left:4%;"><strong>Now Playing </strong></h4>
        </div>
        <div class="col-xs-4 col-sm-2">
            <span class="art2"><img
                    src="https://cdn3.iconfinder.com/data/icons/generic-05/100/less_Is_More_V1.0-61-512.png"
                    width="90px"></span>
        </div>
        <div class="col-xs-8 col-sm-9">
            <p><span class="title">API is down.</span><br>
                <b><span class="author">No Data</span></b></p>
            <div class="live"></div>
            <p class="text-center">
                <h4><small><span class="listen">Offline</span></small></h4>
